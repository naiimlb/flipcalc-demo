  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="absolute left-4 right-4 top-4 flex items-start justify-between gap-3">
          ...
          <div className="flex flex-col items-end gap-2">
            {reco.pepite && (
              <span className="rounded-full border border-or/50 bg-nuit/70 px-3 py-1 text-[11px] font-medium tracking-wide text-orClair backdrop-blur">
                ✦ Pépite
              </span>
            )}
        ...
        <div className="absolute inset-x-0 bottom-0 p-5">
          <h2 className="equilibre font-titre text-[2rem] leading-[1.06] text-ivoire">
            {titre.titre}
          </h2>
      ...
      <div className="border-t border-white/[0.06] px-5 py-4">
        <p className="mb-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-or/80">
          Pourquoi pour toi
        </p>
      ...
      <div className="px-5 pb-4">
        <motion.button
          ...
          className="flex min-h-[52px] w-full items-center justify-center gap-2.5 rounded-douce bg-voile-or text-[16px] font-semibold text-nuit shadow-or"
        >
