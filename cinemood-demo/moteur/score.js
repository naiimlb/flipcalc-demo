/* Généré par scripts/construire-demo.mjs — NE PAS MODIFIER À LA MAIN.
   Source : cinemood/src/lib/reco/score.ts
...
import { dureeEffective, scoreHumeur } from './humeur.js';
import { bonusEpoque } from './epoque.js';
import { decennie } from './profil.js';
import {
  FENETRE_ROTATION_MS,
  FRAICHEUR,
  PENALITES,
...
function meilleureCle(cles          , carte                        )         {
  let meilleure = '';
  let max = -Infinity;
 ...
 */
export function scoreQualite(titre       )         {
...
export function scoreFraicheur(titre       , anneeCourante        )         {
