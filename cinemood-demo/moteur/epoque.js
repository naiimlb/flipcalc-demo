/* Généré par scripts/construire-demo.mjs — NE PAS MODIFIER À LA MAIN.
   Source : cinemood/src/lib/reco/epoque.ts
...
import { AGE_MINIMUM, ECHELLE_AGE, EPOQUE } from './poids.js';
                                                                           

/** Le nom de génération correspondant à une année de naissance. */
export function generation(anneeNaissance        )         {
...
export function ageALaSortie(anneeNaissance        , anneeSortie        )         {
  return anneeSortie - anneeNaissance;
}

/** Âge actuel, calculé sur l'année de référence. */
export function age(anneeNaissance        , anneeCourante        )         {
 ...
 */
export function bonusEpoque(titre       , profil                   , anneeCourante        )         {
...
export function estNostalgique(titre       , profil                   )          {
...
export function classificationPlusStricte(a                , b                )          {
 ...
 */
export function autoriseParAge(titre       , ageUtilisateur        )          {
