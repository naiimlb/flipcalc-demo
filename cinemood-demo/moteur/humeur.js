/* Généré par scripts/construire-demo.mjs — NE PAS MODIFIER À LA MAIN.
   Source : cinemood/src/lib/reco/humeur.ts
...
import { CONTEXTE, TABLE_COMPAGNIE, TABLE_HUMEURS } from './poids.js';
                                                  

/** Durée effective d'un titre : un épisode de série vaut ~45 min. */
export function dureeEffective(titre       )         {
...
export function scoreDuree(duree        , ideale        , tolerance        )         {
...
function recouvrement(liste          , reference          )         {
 ...
 * d'humeur.
 */
export function scoreHumeur(titre       , contexte          )         {
...
export function contexteParDefaut(maintenant         = Date.now())           {
